...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (isset($_POST['delete_table']) && $table_exists) {
...
<?php if ($table_exists): ?>
    <p class="warning">Table "users" already exists.</p>
    <form method="POST">
        <button type="submit" name="delete_table">Delete Table</button>
    </form>
<?php else: ?>
    <form method="POST">
        <button type="submit" name="create_table">Create Table and Insert Data</button>
    </form>
<?php endif; ?>
